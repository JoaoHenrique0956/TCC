...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;}
        ...
        /* ===== TEXTAREA - fonte maior e mais nítida (id vence a classe form-control do Bootstrap) ===== */
        #texto {
            resize: none;
            ...
            border: 1.5px solid #b5b3a8 !important;
        ...
        .feedback-label{font-size:14px;font-weight:600;letter-spacing:.8px;text-transform:uppercase;
        ...
        .feedback-text{font-size:16px;color:#5f5e5a;line-height:1.6;margin:0;}
...
<div id="sidebar" class="sidebar">
    ...
    <a href="/sobre">
        <button class="sidebar-btn">
            <i class="bi bi-question-circle me-2"></i>Sobre
        </button>
    </a>
        ...
        <div class="col-lg-8 left-panel p-4">
            <div class="top-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <p class="app-title">Corretor de Redações</p>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="tema" class="form-control" placeholder="Sem tema">
                </div>
            </div>
            ...
            <div class="mb-2">
                <textarea id="texto" class="form-control p-2" rows="15"
        ...
        <div class="col-lg-4 right-panel p-4">
            ...
            <div class="chart-card">
                ...
                <div class="vertical-chart">
                    ...
                    <div class="bar-column">
                        <div class="bar-track-vertical">
                            <div class="bar-fill-vertical" id="bar-coesaoTextual"></div>
                        </div>
                        <span class="bar-value" id="val-coesaoTextual">0.0</span>
                        <span class="bar-label">Coesão</span>
                    </div>
            ...
            function atualizarGrafico(dados) {
                ...
                const notas = {
                    ...
                    coesaoTextual: parseFloat(dados.nota_coesaoTextual || 0)
                };
            ...
            <div class="feedback-card">
                ...
                <div class="feedback-item">
                    <div class="feedback-label"><span class="dot"></span>Gramática</div>
                ...
                <div class="feedback-item">
                    <div class="feedback-label"><span class="dot"></span>Coesão Textual</div>
                    <p id="txtCoe" class="feedback-text">—</p>
                </div>
                <div class="feedback-item">
...
async function enviar(){
    ...
    try {
        const res  = await fetch("/corrigir",{
            ...
            body:JSON.stringify({texto,genero,tema})
        });
        ...
        document.getElementById("txtCoe").innerText    = data.txtCoe    || "—";
